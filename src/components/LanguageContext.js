...
const languageContent = {
  EN: {
    ...
    Office_listings: 'Office Listings',
    ...
    Mortgage_calculation: 'Mortgage Calculator',
    Transfer_calculation: 'Land Transfer Tax Calculator',
  ...
  Japanese: {
    ...
    Office_listings: '企業リスト',
    Search_listings: '物件検索',
    selling_resources: '売却リソース',
    free_evaluation: '無料査定',
    buying_resources: '購入リソース',
    Mortgage_calculation: '住宅ローン計算機',
    Transfer_calculation: '土地譲渡税計算機',
